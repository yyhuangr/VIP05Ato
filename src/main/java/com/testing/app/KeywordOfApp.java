...
public class KeywordOfApp {
	...
	// 启动被测APP
	public void runBrowser(String deviceName,String platformVersion,String driverpath,String appiumServerIP,String time) {
			try {
				AutoLogger.log.info("启动待测App");
				BrowserDriver browser = new BrowserDriver(deviceName, platformVersion, driverpath);
