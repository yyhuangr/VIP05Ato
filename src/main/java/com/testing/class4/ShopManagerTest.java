...
public class ShopManagerTest {
	public static void main(String[] args) {
		...
		web.halt("5");
		//切换到iframe中
		String goodsname="第五课测试商品";
		//对于商城后台商品页面进行添加商品功能的测试。
		addGoods(web,goodsname);
		web.click("//a[text()='商品列表']");
	...
	public static void addGoods(WebkeyWord web,String goodsName) {
		...
		//文件上传
		web.halt("5");
		web.uploadFile("//div[@id='filePicker']//input[@type='file']", "F:\\疫情.png");
